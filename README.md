...
## Предисловие:
### !!!UPD после отправки на проверку: ВМ прерываемые, к сожалению, машина выключилась и адреса перебило, ссылки не актуальны (работало при сдаче на проверку первые ~12 часов).
